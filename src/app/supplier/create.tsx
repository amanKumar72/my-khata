  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Toast.show({
        ...
        text2: `${supplier.name} has been added successfully`,
      });
      ...
      Toast.show({
        type: 'error',
        text1: 'Error',
        text2: 'Failed to create supplier',
      });
    } finally {
      setLoading(false);
    }
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.scrollContainer}>
        <Card style={styles.card}>
          ...
          />
          <Input
            label="Warehouse / Shop Address"
            value={address}
            onChangeText={setAddress}
            placeholder="e.g. Wholesale Market, Gali 4"
            multiline
            numberOfLines={3}
